...
import CerImg1 from '../../assets/images/Cert1.png'
import CerImg2 from '../../assets/images/Cert2.png'

const About = () => {
    return (
        <div>
             <section className="bg-[#1F1F1F] xl:pt-[149px] xl:pb-[170px]">
        <div className="max-w-container mx-auto">
            <div className="grid md:grid-cols-5 grid-cols-2 gap-x-4 p-5 xl:p-0">
                <div className="grid xl:col-span-2 col-span-3 sm:col-span-1 md:col-span-2">
                    ...
                    <ul>
                        <li><a className="flex items-center mb-[15px]" href="mailto: mail@yourcompany.com">
                                ...
                                <p className="text-sm font-pops font-normal text-white ml-[5px]">mail@yourcompany.com</p>
                            </a></li>
                        <li><a className="flex items-center mb-[15px]" href="mailto: mail@yourcompany.com">
                                <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 20 20"
                                    fill="none">
                                ...
                                <p className="text-sm font-pops font-normal text-white ml-[5px]">+896 120 5889 (Toll free)
                                </p>
                            </a></li>
                        <li><a className="flex items-center" href="mailto: mail@yourcompany.com">
                                <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 20 20"
                                    fill="none">
                                    <path
                                ...
                                <p className="text-sm font-pops font-normal text-white ml-[5px]">101 Baker Street, New York,
                                    USA, 12345</p>
                            </a></li>
                    </ul>
                    </div>
                    <div className="flex mt-[34px]">
                        <div
                            className="w-7 h-7 bg-primary rounded-full flex items-center justify-center mr-3 hover:bg-transparent ">
                        ...
                        <div
                            className="w-7 h-7 bg-primary rounded-full flex items-center justify-center hover:bg-transparent ">
                            <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" viewBox="0 0 16 16"
                                fill="none">
                                <path
                ...
                <div className="xl:mr-[124px] mt-[30px]">
                    <h3 className="font-pops font-bold text-base text-white mb-[21px]">Company</h3>
                    <ul>
                        <li><a className="font-pops font-normal text-sm text-white hover:text-primary duration-500 mb-[15px]"
                                href="#">Home</a></li>
                        <li><a className="font-pops font-normal text-sm text-white hover:text-primary duration-500 mb-[15px]"
                                href="#">About</a></li>
                        <li><a className="font-pops font-normal text-sm text-white hover:text-primary duration-500 mb-[15px]"
                                href="#">Services</a></li>
                        <li><a className="font-pops font-normal text-sm text-white hover:text-primary duration-500"
                                href="#">Gallery</a></li>
                    </ul>
                </div>
                <div className="mr-[83px] mt-[30px]">
                    <h3 className="font-pops font-bold text-base text-white mb-[21px]">Others</h3>
                    <ul>
                        <li><a className="font-pops font-normal text-sm text-white hover:text-primary duration-500 mb-[15px]"
                                href="#">Blog</a></li>
                        <li><a className="font-pops font-normal text-sm text-white hover:text-primary duration-500 mb-[15px]"
